...
const MUSCLE_OPTIONS: MuscleGroup[] = [
  "chest", "back", "shoulders", "biceps", "triceps", "quads", "hamstrings", "glutes", "calves", "core", "forearms", "cardio",
];
const EQUIPMENT_OPTIONS: Equipment[] = [
  "barbell", "dumbbell", "machine", "cable", "bodyweight", "kettlebell", "band", "pullup-bar", "bench", "other",
];
...
export function ExercisePicker({
  ...
  const [draft, setDraft] = useState<{ name: string; muscleGroup: MuscleGroup; equipment: Equipment; category: Exercise["category"] }>({
    name: "", muscleGroup: "chest", equipment: "barbell", category: "compound",
  });
              ...
              {filtered.map((ex) => (
                <li key={ex.id}>
                  ...
                  >
                    ...
                    {ex.custom && <Badge variant="secondary" className="text-[10px]">Custom</Badge>}
      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}>
        <DialogContent>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Select value={draft.muscleGroup} onValueChange={(v) => setDraft({ ...draft, muscleGroup: v as MuscleGroup })}>
              ...
              <div>
                ...
                <Select value={draft.equipment} onValueChange={(v) => setDraft({ ...draft, equipment: v as Equipment })}>
                  <SelectTrigger><SelectValue /></SelectTrigger>
                  <SelectContent>
            ...
            <div>
              ...
              <Select value={draft.category} onValueChange={(v) => setDraft({ ...draft, category: v as Exercise["category"] })}>
                <SelectTrigger><SelectValue /></SelectTrigger>
                <SelectContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={saveCustom} disabled={!draft.name.trim()}>Create & add</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </>
